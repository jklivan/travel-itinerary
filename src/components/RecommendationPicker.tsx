...
import { Ban, BedDouble, Star } from 'lucide-react'
...
export default function RecommendationPicker({ type, value, onChange }: {
  ...
  return (
    <fieldset className="space-y-1.5">
      <legend className="text-xs font-medium text-gray-600">Your recommendation</legend>
      ...
      <p className="text-[11px] text-gray-500">Optional. Select again to remove the stamp.</p>
    </fieldset>
  )
}
