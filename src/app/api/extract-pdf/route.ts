...
- Use common sense and assess the document as a whole, not one line in isolation. Include accommodation when the overall context makes it clear with high confidence that this is where the traveller is staying, even if the booking details are absent. Strong evidence includes a prominent hotel name or hotel logo in the header, cover, letterhead, or recurring page header; a named property paired with the itinerary; or repeated references that establish the property as the base for the trip. Extract it as "hotel". Do not treat a generic supplier logo, a meeting point, or a passing hotel mention as accommodation, and never invent a hotel from the destination alone.
