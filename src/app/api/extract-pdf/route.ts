...
- Include accommodation when the document explicitly names or states the hotel, resort, inn, villa, lodging, accommodation, or stay. A prominent hotel name or hotel logo in the document header, cover, letterhead, or recurring page header is explicit evidence that this is the traveller's accommodation, even when the nightly booking details are not shown; extract it as "hotel". Do not treat a generic supplier logo, a meeting point, or a hotel merely mentioned in itinerary context as accommodation. Never infer or invent a hotel from a destination alone. Classify qualifying accommodation as "hotel".
