...
import { MapPin, Hotel, Utensils, Camera, Plane, Check, X, ImageIcon, GripVertical, ArrowRight, Plus } from 'lucide-react'
import {
  DndContext,
  DragOverlay,
  PointerSensor,
...
import PlaceEditForm, { StarRating, inputCls, MEAL_TYPES, MEAL_EMOJI, MEAL_ACTIVE, ITEM_TAGS } from '@/components/PlaceEditForm'
  ...
  if (isEditing) {
    return (
      <div ref={setNodeRef} style={style}>
        {dayControl}
        <PlaceEditForm type={item.type} initial={item} onDraftChange={onDraftChange} onSave={onUpdate} onClose={onEdit} onRecommendationChange={onRecommendationChange} city={city} />
