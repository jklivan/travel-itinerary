-- Remove budget and currency
ALTER TABLE "Itinerary" DROP COLUMN IF EXISTS "budget";
ALTER TABLE "Itinerary" DROP COLUMN IF EXISTS "currency";

-- Add audience
ALTER TABLE "Itinerary" ADD COLUMN "audience" TEXT NOT NULL DEFAULT 'family';
